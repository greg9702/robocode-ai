...
javac -classpath ${SCRIPT_PATH}/robocode/libs/robocode.jar:${SCRIPT_PATH}/log4j/log4j-api-2.14.0.jar:${SCRIPT_PATH}/log4j/log4j-core-2.14.0.jar ${SCRIPT_PATH}/my-robot/*.java
