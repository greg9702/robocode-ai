...
JVM_ARGS="${JVM_ARGS} -DtestRounds=${TEST_ROUNDS}"
...
#printf "robocode.battle.selectedRobots=iwium.MiddleRobot*,sample.SpinBot\n" >> ${BATTLE_PATH}
#printf "robocode.battle.selectedRobots=iwium.Hunter*,sample.SpinBot\n" >> ${BATTLE_PATH}
printf "robocode.battle.selectedRobots=iwium.DeterministicRobot*,sample.SpinBot\n" >> ${BATTLE_PATH}
